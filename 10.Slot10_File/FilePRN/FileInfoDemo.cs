...
namespace FilePRN
{
    class FileInfoDemo
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Creation time: {testFile.CreationTime}"); // Last Write Time
            Console.WriteLine($"Last Write Time: {testFile.LastWriteTime}"); // Name of parent Directory.
