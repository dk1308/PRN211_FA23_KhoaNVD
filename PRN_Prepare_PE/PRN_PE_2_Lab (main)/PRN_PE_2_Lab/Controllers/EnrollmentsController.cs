...
namespace PRN_PE_2_Lab.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var myDBContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("StudentId,CourseId,DateUpdate")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,CourseId,DateUpdate")] Enrollment enrollment)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyDBContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
